...
"})
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="fixes_to_cv_date", type="date", nullable=true)
     */
    private $fixesToCvDate;
    ...
    public function getFixesToCvDate(): ?\DateTimeInterface
    {
        return $this->fixesToCvDate;
    }

    public function setFixesToCvDate(?\DateTimeInterface $fixesToCvDate): static
    {
        $this->fixesToCvDate = $fixesToCvDate;
