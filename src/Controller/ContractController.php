...
class ContractController extends AbstractController
{
	...
	{ 
		...
		if($token === false){
			...
			$specificFunctions = $data['specific_functions'] ?? null;
			if ($specificFunctions === 'null') {
				$specificFunctions = null;
			}

			$directContract->setSpecificFunctions($specificFunctions);
  ...
  public function generateDataBaseExcel(Request $request, ManagerRegistry $doctrine): BinaryFileResponse
  {
	  ...
	  // Agregar encabezados
	  $headers = [
		  'Nombre', 'Apellido', 'NUM_DOCUMENTO', 'Periodo', 'Tipo de Contrato' ,'LUGAR_EXPEDICION', 'FECHA_NACIMIENTO',
